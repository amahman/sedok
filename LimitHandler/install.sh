...
wget -O /usr/bin/monitor_quota.py https://raw.githubusercontent.com/amahman/sedok/main/LimitHandler/monitor_quota.py

# Download autokill.py
echo "✅ Downloading monitor_autokill.py..."
wget -O /usr/bin/monitor_autokill.py https://raw.githubusercontent.com/amahman/sedok/main/LimitHandler/monitor_autokill.py
...
touch /var/log/rmbl_quota_monitor.log
chmod 644 /var/log/rmbl_quota_monitor.log
...
Restart=always
RestartSec=10
StandardOutput=append:/var/log/rmbl_quota_monitor.log
StandardError=append:/var/log/rmbl_quota_monitor.log
